...
<tr><th>MOTHER</th><td>{mother}</td><th>DOB</th><td>{dob}</td></tr>
<tr><th>CLASS</th><td>{cls}</td><th>SECTION</th><td>A</td></tr>
<tr><th>MOBILE</th><td>{mobile}</td><th>-</th><td>-</td></tr>
...
<tr><th>HEALTH AND PHYSICAL EDUCATION</th><td>A</td><th>VALUES</th><td>A</td></tr>
<tr><th>MORAL SCIENCE</th><td>A</td><th>ATTANDANCE</th><td>A</td></tr>
</table>
<br>
...
'''
#qr codes & other data can be added here
        else:
...
class Fees_slip:
    def view_fees_slip(self,st_id,amount,slip_id):
        html_text = ''
        conn,cursor = funt.Data().data_base_function()
